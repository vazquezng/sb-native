...
class LoginScreen extends Component {
  ...
  goProfile(newuser) {
    ...
    const resetAction = NavigationActions.reset({
      index: 0,
      key: newuser ? 'Welcome' : 'Home',
      actions: [NavigationActions.navigate({ routeName: newuser ? 'Welcome' : 'Home' })],
    });
  ...
  _renderBullet(index) {
    if (this.state.pager === index) {
      return (
        <View style={{
 width: 7, height: 7, backgroundColor: '#ffffff', borderRadius: 7, marginHorizontal: 2,
}}
        >
    ...
    return (
      <View style={{
 width: 7, height: 7, backgroundColor: 'transparent', borderRadius: 7, borderWidth: 1, borderColor: '#ffffff', marginHorizontal: 2,
}}
      >
        <Text style={{ color: 'transparent', fontSize: 30, backgroundColor: 'transparent' }}>{'\u2022'}{'\u2022'}{'\u2022'}</Text>
      </View>
      ...
      <View style={{ flex: 1 }} onLayout={this._onLayoutDidChange}>
        ...
        >
          <View style={[{ backgroundColor: 'black' }, this.state.size]}>
            <ImageBackground style={[{ backgroundColor: 'black' }, this.state.size]} source={require('../../assets/login01.png')}>
              <View style={{
 flex: 1, justifyContent: 'center', alignItems: 'center', paddingHorizontal: 40,
}}
              >
                <Text style={{
 color: '#ffffff', textAlign: 'center', fontFamily: 'OpenSans', fontSize: 21, backgroundColor: 'transparent',
}}
                >
          ...
          <View style={[{ backgroundColor: 'black' }, this.state.size]}>
            <ImageBackground style={[{ backgroundColor: 'black' }, this.state.size]} source={require('../../assets/login02.png')}>
              <View style={{
 flex: 1, justifyContent: 'center', alignItems: 'center', paddingHorizontal: 40,
}}
              >
 ...
 color: '#ffffff', textAlign: 'center', fontFamily: 'OpenSans', fontSize: 21, backgroundColor: 'transparent',
          ...
          <View style={[{ backgroundColor: 'black' }, this.state.size]}>
            <ImageBackground style={[{ backgroundColor: 'black' }, this.state.size]} source={require('../../assets/login03.png')}>
              <View style={{
 flex: 1, justifyContent: 'center', alignItems: 'center', paddingHorizontal: 40,
}}
              >
 ...
 color: '#ffffff', textAlign: 'center', fontFamily: 'OpenSans', fontSize: 21, backgroundColor: 'transparent',
        ...
        <View style={[{
 backgroundColor: 'rgba(0, 0, 0, .4)', paddingBottom: 10, paddingTop: 10, position: 'absolute', top: 0, width,
}]}
        >
          <Image
        ...
        <View style={[styles.loginContent, { bottom: 50 }]}>
          <View style={{
 flexDirection: 'row', width: 200, justifyContent: 'center', marginBottom: 10,
}}
          >
          ...
          <Text style={{
 color: '#ffffff', paddingLeft: 5, paddingBottom: 20, backgroundColor: 'transparent',
}}
          >Iniciá sesión y empeza a jugar
          </Text>
          <TouchableItem
            style={{
 backgroundColor: '#3b5998', height: 30, width: 200, marginBottom: 10, borderRadius: 5,
}}
 ...
 flex: 1, flexDirection: 'row', justifyContent: 'center', alignItems: 'center',
          ...
          <TouchableItem
            style={{
 backgroundColor: '#5baceb', height: 30, width: 200, borderRadius: 5, marginBottom: 10,
}}
 ...
 flex: 1, flexDirection: 'row', justifyContent: 'center', alignItems: 'center',
          ...
          <TouchableItem
            style={{
 backgroundColor: 'red', height: 30, width: 200, borderRadius: 5,
}}
 ...
 flex: 1, flexDirection: 'row', justifyContent: 'center', alignItems: 'center',
        ...
        <View style={{
 position: 'absolute', bottom: 0, width, justifyContent: 'center', alignItems: 'center',
}}
        >
          <TouchableItem
            onPress={() => {
          ...
          >
            <View style={{
 borderBottomWidth: 1, borderColor: 'white', paddingBottom: 2, marginBottom: 5,
}}
            >
